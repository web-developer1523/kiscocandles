 ...
 */
class ThemeInitTests extends DoctorSuite {
    constructor() {
        super(...arguments);
        this.themeName = '';
        this.themePath = '';
...
ThemeInitTests.description = 'Tests the theme init command creates a valid theme structure';
export default ThemeInitTests;
