...
document.querySelector(".header-custom-search").addEventListener("focus",function(e){console.log("ffdsffs"),document.querySelector(".header-desktop-trigger-click").click()});